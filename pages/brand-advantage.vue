  ...
  <client-only>
    <div class="container">
      ...
      <div class="top-banner">
        <img src="../assets/images/banner/brand_banner.png" />
      </div>
...
export default {
  ...
  head() {
    return {
      title: "品牌优势_大巴租赁_商务车租赁_大巴车租赁平台—安昇租车",
      meta: [
        {
          name: "keywords",
          content: "大巴租赁,商务车租赁,大巴租赁平台"
        },
        {
          name: "description",
          content:
            "安昇租车依托移动互联网、大数据和人工智能技术，整合、优化巴士租赁市场，打破用户与车辆单位之间信息不对称的现状，实现用户与车辆单位无缝对接，打造出行行业透明化网约巴士平台。"
        }
      ]
    };
  }
